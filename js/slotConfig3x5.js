...
*/
        ...
        */
        ...
        scene.slot =  scene.addSpriteLocPos('slot', -290, -145);
        scene.slot.depth = -1;
       ...
       // scene.lanternright =  scene.addSpriteLocPos('lantern_right', 720, -463).setOrigin(0.5, 0.05);   
        ...
        scene.reelholderbot =  scene.addSpriteLocPos('reelholderbot', 600, -450);
        scene.columnLeft =  scene.addSpriteLocPos('column_left', -820, 140);
        scene.columnRight =  scene.addSpriteLocPos('column_right', 350, -650);
        scene.slotLogo = scene.addSpriteLocPos('slotLogo', 450, -450 + 220);
...
//        slotControls.winPanel.setDepth(depth);
        ...
        slotControls.totalBetMinusButton.create(440, 360, 0.5, 0.5);
        ...
        slotControls.totalBetPlusButton.create(840, 360, 0.5, 0.5);
        ...
        slotControls.slotMaxBetButton.create(-2500, 160 + 220, 0.5, 0.5);
        ...
        slotControls.slotAutoSpinButton.create(650, 110 + 200, 0.5, 0.5);
        ...
        slotControls.slotSpinButton.create(2500, 173 + 200, 0.5, 0.5);
        ...
        slotControls.menuButton.create(800, -500, 0.5, 0.5);
        ...
        slotControls.creditSumText = scene.add.bitmapText(scene.centerX + 765, scene.centerY + 80, 'gameFont_1', '' + scene.slotPlayer.coins, 60, 1).setOrigin(0.5);
       ...
       //  settings button
        ...
        slotControls.settingsButton.create(800, -390, 0.5, 0.5);
       ...
       slotControls.rulesButton.create(800, -280, 0.5, 0.5);
...
//        slotControls.linesCountText.depth = depth;
        ...
        slotControls.totalBetText = scene.add.bitmapText(scene.centerX + 600, scene.centerY + 140, 'gameFont_2', 'TOTAL  BET:', 60, 1).setOrigin(0.5);
        slotControls.totalBetText.depth = depth;
  
        slotControls.totalBetSumText = scene.add.bitmapText(scene.centerX + 800 , scene.centerY + 140, 'gameFont_1', slotControls.getTotalBet(), 60, 1).setOrigin(0.5);
        slotControls.totalBetSumText.depth = depth;
 
        slotControls.creditText = scene.add.bitmapText(scene.centerX + 570, scene.centerY + 80, 'gameFont_2', 'BALANCE:', 60, 1).setOrigin(0.5);
        slotControls.creditText.depth = depth;

         
        slotControls.winText = scene.add.bitmapText(scene.centerX + 580, scene.centerY + 20, 'gameFont_2', 'YOUR  WIN:', 60, 1).setOrigin(0.5);
        slotControls.winText.depth = depth;

        slotControls.winAmountText = scene.add.bitmapText(scene.centerX + 780, scene.centerY + 20, 'gameFont_1', '0', 60, 1).setOrigin(0.5);
...
//        slotControls.maxBetText1.depth = depth;
    ...
    createSettingsPUHandler: function(popup,slotControls)
    {
        ...
        popup.addButton('betButton','extralong_button', 'extralong_button_hover', false, -2, 220 + yOffset);
        popup['betButton'].clickEvent.add(()=>{popup.scene.soundController.playClip('button_click', false);}, popup);
        popup['betButton'].clickEvent.add(()=>{
            slotControlsTmp.slotMaxBetButton.click();
        }, popup);
        ...
        popup.privacyText = popup.scene.add.bitmapText(-2, 0 + yOffset, 'gameFont_1', 'Recovery Balance', 46, 1).setOrigin(0.5);
        popup.add(popup.privacyText);

        popup.termsText = popup.scene.add.bitmapText(-2, 110 + yOffset, 'gameFont_1', 'Add ten thousand', 35, 1).setOrigin(0.5);
        popup.add(popup.termsText);
        
        popup.termsText = popup.scene.add.bitmapText(-2, 220 + yOffset, 'gameFont_1', 'Max Bet', 46, 1).setOrigin(0.5);
        popup.add(popup.termsText);
    },
